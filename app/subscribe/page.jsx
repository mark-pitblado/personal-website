        ...
        <div className="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
            <div className="bg-white dark:bg-gray-900 px-6 py-12 shadow sm:rounded-lg sm:px-12">
              <form className="space-y-6"   action="https://buttondown.email/api/emails/embed-subscribe/mark-pitblado"
  method="post"
  target="popupwindow"
  onsubmit="window.open('https://buttondown.email/mark-pitblado', 'popupwindow')">
              ...
              <div>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" fill="currentColor" viewBox="0 0 448 512"><path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64H384c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zM96 136c0-13.3 10.7-24 24-24c137 0 248 111 248 248c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-110.5-89.5-200-200-200c-13.3 0-24-10.7-24-24zm0 96c0-13.3 10.7-24 24-24c83.9 0 152 68.1 152 152c0 13.3-10.7 24-24 24s-24-10.7-24-24c0-57.4-46.6-104-104-104c-13.3 0-24-10.7-24-24zm0 120a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg>
            ...
            <p className="mt-10 text-center text-sm">
              ...
              <a href="https://buttondown.email/refer/mark-pitblado" target="_blank" className="font-semibold leading-6 text-indigo-500 hover:text-indigo-600 dark:text-lime-200 dark:hover:text-lime-300">
                Buttondown
              </a>
            </p>
          </div>
